...
public class NGconf extends JFrame implements ActionListener {
    ...
    public static double cutOffGrade = 70.50;
    ...
    public NGconf() {
        ...
        JLabel title = new JLabel("NEEDED GRADE CONFIG");
